...
void triggerAnims(char payload){
  ...
  else if (payload == 'a') lightAnim1();
  else if (payload == 'b') runningLight1();
  else if (payload == 'c') lightAnim_pulse();
}
...
void toWhite(){
  ...
  color_g = 255 * BRIGHTNESS /255;
  color_b = 255 * BRIGHTNESS /255;
  animSpeed = 8;
  fastled_delay = 25;
}
...
void toYellow(){
  ...
  doAnimateRunningLight = false;
  doFadeToColor = true;
  color_r = 82 * BRIGHTNESS /255;
  color_g = 54 * BRIGHTNESS /255;
...
void toCyan(){
  ...
  doAnimateRunningLight = false;
  doFadeToColor = true;
  color_r = 126 * BRIGHTNESS /255;
  color_g = 209 * BRIGHTNESS /255;
  color_b = 100 * BRIGHTNESS /255;
  animSpeed = 8;
  fastled_delay = 25;
}
